...
from group_blog import app, db, bcrypt, mail
from group_blog.forms import (RegistrationForm, LoginForm, UpdateAccountForm,
...
def reset_request():
    ...
    if form.validate_on_submit():
        ...
        flash('An email has been sent with instructionst to reset your password.', 'info')
        return redirect(url_for('login'))
